...
export const profileRouter = createTRPCRouter({
  ...
  toggleFollow: protectedProcedure
    ...
    .mutation(async ({ input: { userId }, ctx }) => {
      ...
      //find out whether I already follow the user
      ...
      // Revalidation, to update the follow count after first site generation (otherwise original follow count will be kept)
